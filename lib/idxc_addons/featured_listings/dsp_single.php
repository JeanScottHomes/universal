...
/* MOVED TO /templates/featured-listings-layout.php
$prefix = "_idxc_mb_featuredlistings_"; // Define your prefix here
...
$prefix = "_idxc_mb_featuredlistings_"; // Define your prefix here
$layout_include = get_stylesheet_directory() . '/templates/featured-listings-layout.php';
$main_class_wrapper = "listing_layout_single2";
...
<div id="<?php echo $main_class_wrapper; ?>" class="entry-content">
	...
	<?php // Assign values to variables to be used
			...
			$price_sold = get_post_meta($post->ID, $prefix . "price_sold", $single = true);
			...
			$zillow_tour_url	= get_post_meta($post->ID, $prefix . "zillow_tour_url", $single = true);
			$tour_image 		= get_post_meta($post->ID, $prefix . "tour_image", $single = true);
			$map_code 			= get_post_meta($post->ID, $prefix . "map_code", $single = true);
			$status 			= get_post_meta($post->ID, $prefix . "status", $single = true);
