...
/* 
 * MOVED FROM: 
 * universal/lib/idxc_addons/featured_listings/layouts/layout_single2.php_080625_0816
 * TJS 09/07/25
 * /

/* Add-on: Featured Listings
 * Layout: Featured Listings Layout
 * Created: 2024-04-03
 * Author: Mark Moineau
 * Version: 1.0.0
*/
...
// Check if Featured Image is set. If set, nothing, if not set, then add Page Tile section
...
<div class="ao_listing_layout2">
	...
	<div id="details" class="isc_info_bar_container iul_full_width isc_color1">
		<div class="wrap isc_info_bar_wrap">

			<div class="breadcrumbs-h1-wrap">
